...
LootTable.removeGlobalItem("mysticalworld:silver_ingot");
LootTable.removeGlobalItem("mysticalworld:amethyst_gem");

LootTable.removeGlobalItem("ebwizardry:scroll:*");
LootTable.removeGlobalItem("ebwizardry:scroll:23");
