...
[<minecraft:gold_ingot>, <ore:obsidian>, <minecraft:gold_ingot>],
[<ore:gemSapphire>,<ore:obsidian>,<ore:gemSapphire>]]);

recipes.remove(<arcaneworld:block_sapphire>);

recipes.remove(<arcaneworld:levitator>);
recipes.addShaped(<arcaneworld:levitator>,
